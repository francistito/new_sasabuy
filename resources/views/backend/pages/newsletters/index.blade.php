...
@section('title')
    {{  ('Send Bulk Emails') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Send Bulk Emails') }}</h2>
                            </div>
            ...
            <div class="row g-4">
                    ...
                    <form action="{{ route('admin.newsletters.send') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="d-none">
                                    <label for="user_emails" class="form-label">{{  ('Select Users') }}</label>
                                    <select class="form-select form-control select2"
                                        data-placeholder="{{  ('Select Users') }}" data-toggle="select2"
                                ...
                                <div class="mb-4">
                                    <label for="subscriber_emails" class="form-label">{{  ('Subscribers') }}</label>
                                    <select class="form-select form-control select2"
                                        data-placeholder="{{  ('Select Subscribers') }}" data-toggle="select2"
                        ...
                        <div class="mb-4">
                            <button class="btn btn-primary" type="submit">
                                <i data-feather="save" class="me-1"></i> {{  ('Send Emails') }}
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-4">{{  ('Send Bulk Emails') }}</h5>
