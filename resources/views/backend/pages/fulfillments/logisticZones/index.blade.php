...
@section('title')
    {{  ('Shipping Zones') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">{{  ('Shipping Zones') }}</h2>
                                    </div>
                                </div>
                                <div class="col-auto">
                                ...
                                @can('add_shipping_zones')
                                    <div class="col-auto">
                                        <a href="{{ route('admin.logisticZones.create') }}" class="btn btn-primary"><i
                                                data-feather="plus"></i>{{  ('Add Zone') }}</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
                    ...
                    <div class="card mb-4" id="section-1">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group">
                                            <select class="form-select select2" name="searchLogistic"
                                                ...
                                                <option value="">{{  ('Select a Logistic') }}</option>
                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%">{{  ('Name') }}</th>
                                    <th width="15%">{{  ('Logistic') }}</th>
                                    <th data-breakpoints="xs sm">{{  ('Cities') }}</th>
                                    <th data-breakpoints="xs sm" width="10%">{{  ('Shipping Time') }}</th>
                                    <th data-breakpoints="xs sm" width="10%">{{  ('Shipping Charge') }}</th>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_shipping_zones')
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.logisticZones.edit', ['id' => $logisticZone->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}& ">
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>{{  ('Showing') }}
                                ...
                                {{  ('of') }}
                                {{ $logisticZones->total() }} {{  ('results') }}</span>
                            <nav>
