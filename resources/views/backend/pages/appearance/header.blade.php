...
@section('title')
    {{  ('Website Header Configuration') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Website Header Configuration') }}</h2>
                            </div>
            ...
            <div class="row g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="topbar_email" id="topbar_email" class="form-control"
                                        placeholder="{{  ('grostore@support.com') }}"
                                        value="{{ getSetting('topbar_email') }}">
                                </div>

                                <div class="mb-3">
                                    <label for="topbar_location"
                                        class="form-label">{{  ('Topbar Location') }}</label>
                                    ...
                                    <input type="text" name="topbar_location" id="topbar_location" class="form-control"
                                        placeholder="{{  ('Washington, New York, USA - 254230') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="navbar_pages[]" class="w-100"
                                        data-toggle="select2" data-placeholder="{{  ('Select pages') }}" multiple>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-4">{{  ('Header Configuration') }}</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">{{  ('Topbar Information') }}</a>
                                    </li>
                                    <li>
                                        <a href="#section-2">{{  ('Navbar Information') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
