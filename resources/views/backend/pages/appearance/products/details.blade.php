                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Product Details Widget') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                                    ...
                                                    <div class="dropdown tt-tb-dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end shadow">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.appearance.products.details.editWidget', ['id' => $widget->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}& ">
                    ...
                    <form action="{{ route('admin.appearance.products.details.storeWidget') }}" method="POST"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="mb-3">{{  ('Add New Widget') }}</h5>
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="mb-3">{{  ('Add Promotional Banner') }}</h5>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="product_page_banner_link" id="product_page_banner_link"
                                        placeholder="{{  ('Type link') }}" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">{{  ('Choose Promotional Banner') }}</span>
                                        <!-- choose media -->
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">{{  ('Product Details Page') }}</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-one" class="active">{{  ('Widgets') }}</a>
                                    </li>

                                    <li>
                                        <a href="#section-banner">{{  ('Promotional Banner') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
