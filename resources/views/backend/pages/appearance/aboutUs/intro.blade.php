                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Intro Section') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_title" class="form-label">{{  ('Title') }}</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_text" class="form-label">{{  ('Text') }}</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_mission" class="form-label">{{  ('Mission') }}</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_vision" class="form-label">{{  ('Vision') }}</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_quote" class="form-label">{{  ('Quote') }}</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_quote_by" class="form-label">{{  ('Quote By') }}</label>
                                    <input type="hidden" name="types[]" value="about_intro_quote_by">
                                    <input type="text" name="about_intro_quote_by" id="text"
                                        placeholder="{{  ('Type name of the user') }}" class="form-control"
