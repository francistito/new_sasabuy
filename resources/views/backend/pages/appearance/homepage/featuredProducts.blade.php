                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Featured Products') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    <label for="featured_sub_title"
                                        class="form-label">{{  ('Section Sub Title') }}</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <label class="form-label">{{  ('Left Column Products') }}</label>
                                    <input type="hidden" name="types[]" value="featured_products_left">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="{{  ('Select products for left column') }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <label class="form-label">{{  ('Right Column Products') }}</label>
                                    <input type="hidden" name="types[]" value="featured_products_right">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="{{  ('Select products for right column') }}"
                                ...
                                <div class="mb-4">
                                    <label class="form-label">{{  ('Center Banner Image') }}</label>
                                ...
                                <div class="mb-4">
                                    <label for="featured_banner_link"
                                        class="form-label">{{  ('Banner Link') }}</label>
