                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Weekly Best Deals') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date-picker" type="text"
                                            placeholder="{{  ('End date') }}" name="best_deal_end_date"
                                ...
                                <div class="mb-3">
                                    ...
                                    @endphp
                                    <label class="form-label">{{  ('Best Deal Products') }}</label>
                                    <input type="hidden" name="types[]" value="weekly_best_deals">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="{{  ('Select products') }}" name="weekly_best_deals[]"
                                        required>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-3">{{  ('Homepage Configuration') }}</h5>
