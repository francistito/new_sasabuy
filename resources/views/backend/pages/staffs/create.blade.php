...
@section('title')
    {{  ('Add New Employee Staff') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Add New Staff') }}</h2>
                            </div>
            ...
            <div class="row mb-4 g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="name"
                                        placeholder="{{  ('Type staff name') }}" name="name" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="email" id="email"
                                        placeholder="{{  ('Type staff email') }}" name="email" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="phone"
                                        placeholder="{{  ('Type staff phone') }}" name="phone">
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i> {{  ('Save Staff') }}
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-4">{{  ('Staff Information') }}</h5>
