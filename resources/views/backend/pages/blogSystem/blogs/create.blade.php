...
@section('title')
    {{  ('Add New blog') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Add Blog') }}</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="short_description" id="short_description" rows="4"
                                        placeholder="{{  ('Type your short description') }}"></textarea>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i> {{  ('Save Blog') }}
                                    </button>
                                </div>
                            </div>
                        </div>
