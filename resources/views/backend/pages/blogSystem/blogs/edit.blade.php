...
@section('title')
    {{  ('Update Blog') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">{{  ('Update Blog') }} <sup
            ...
            <div class="row mb-4 g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="title" id="title"
                                        placeholder="{{  ('Type blog title') }}" class="form-control" required
                                ...
                                @if (env('DEFAULT_LANGUAGE') == $lang_key)
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="slug" id="slug"
                                            placeholder="{{  ('Type blog slug') }}" class="form-control" required
                                            value="{{ $blog->slug }}">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <label for="video_link"
                                            class="form-label">{{  ('Youtube Video Link') }}</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="short_description" id="short_description" rows="4"
                                        placeholder="{{  ('Type your short description') }}">{{ $blog->collectLocalization('short_description', $lang_key) }}</textarea>
                                </div>
                        ...
                        @if (env('DEFAULT_LANGUAGE') == $lang_key)
                            ...
                            <div class="card mb-4" id="section-2">
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">{{  ('Thumbnail Image') }} (600x400)</label>
                                        <div class="tt-image-drop rounded">
                                            <span class="fw-semibold">{{  ('Choose Blog Thumbnail') }}</span>
                                            <!-- choose media -->
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">{{  ('Blog Details Image') }}
                                            (1200x700)</label>
                                        <div class="tt-image-drop rounded">
                                            <span class="fw-semibold">{{  ('Choose Blog Details Image') }}</span>
                                            <!-- choose media -->
                                            <div class="tt-product-thumb show-selected-files mt-3">
                                                <div class="avatar avatar-xl cursor-pointer choose-media"
                                                    data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="meta_description" id="meta_description" rows="4"
                                            placeholder="{{  ('Type your meta description') }}">{{ $blog->meta_description }}</textarea>
                                    </div>
                                    <div class="mb-4">
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-4">{{  ('Blog Information') }}</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    ...
                                    @if (env('DEFAULT_LANGUAGE') == $lang_key)
                                        <li>
                                            <a href="#section-2">{{  ('Blog Images') }}</a>
                                        </li>
                                        <li>
                                            <a href="#section-3">{{  ('SEO Meta Options') }}</a>
                                        </li>
                                    @endif
                                </ul>
                            </div>
