...
@section('title')
    {{  ('Update Profile') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{  ('Update Profile') }}</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="name"
                                        placeholder="{{  ('Type your name') }}" name="name" required
                                        value="{{ $user->name }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">{{  ('Choose Avatar') }}</span>
                                        <!-- choose media -->
