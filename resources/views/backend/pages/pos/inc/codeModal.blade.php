    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-4">
            <div class="modal-header border-bottom-0 pb-0">
                <h2 class="modal-title h5 text-capitalize" id="addItemCodeLabel">{{  ('Enter product code') }}</h1>
            </div>
            <form action="" class="add-item-by-code-form">
                    ...
                    <div class="tt-search-box">
                        <div class="input-group">
                            ...
                            <input class="form-control rounded-start w-100 product_variation_code" type="text"
                                name="product_variation_code" placeholder="{{  ('Enter product code') }}"
                                required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-start border-top-0">
                    ...
                    <button type="submit"
                        class="btn btn-primary add-item-by-code-btn">{{  ('Add This Item') }}</button>
                </div>
            </form>
        </div>
    </div>
