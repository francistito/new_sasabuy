...
@section('title')
    {{  ('Categories') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{  ('Category Name') }}</th>
                                    <th data-breakpoints="xs sm">{{  ('Base Category') }}</th>
                                    <th data-breakpoints="xs sm">{{  ('Brands') }}</th>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    @can('edit_categories')
                                                        <a class="dropdown-item"
                                                            href="{{ route('product.categories.edit', ['id' => $category->id, 'lang_key' => env('DEFAULT_LANGUAGE')]) }}& ">
                                                    ...
                                                    @can('delete_categories')
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="{{ route('product.categories.delete', $category->id) }}"
                                                            title="{{  ('Delete') }}">
...
@section('scripts')
    <script>
        ...
        function updateFeatureStatus(el) {
            ...
            $.post('{{ route('product.categories.updateFeatureStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
        ...
        function updateTopStatus(el) {
            ...
            $.post('{{ route('product.categories.updateTopStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
