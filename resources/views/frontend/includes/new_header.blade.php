            ...
            <div class="container">
                <div class="d-flex align-items-center">
                    <div class="topbar-left">
                        <a href="#" class="text-gray-70 font-size-13 u-header-topbar__nav-link sasabuy_text_color">Your Local Advertiser</a>
                    </div>
                    <div class="topbar-right ml-auto">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a href="#" class="u-header-topbar__nav-link sasabuy_text_color"><i class="ec ec-map-pointer mr-1"></i> Store Locator</a>
                            </li>
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border full-bg">
                                <a href="#" class="u-header-topbar__nav-link sasabuy_text_color"><i class="ec ec-transport mr-1"></i> Track Your Order</a>
                            </li>
                    ...
                    <div class="col-auto">
                        ...
                        <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                            ...
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="../home/index.html" aria-label="Electro">
                                <img src="{{url('assets/img/nobg.png')}}" alt=""  style="margin-bottom: 0;height: 79.52px;width: auto" />
                            </a>
                            <!-- End Logo -->
                                    ...
                                    <div class="u-header-sidebar__footer-offset pb-0">
                                        ...
                                        <div class="position-absolute top-0 right-0 z-index-2 pt-4 pr-7">
                                            <button type="button" class="close ml-auto"
                                                    ...
                                                    data-unfold-animation-out="fadeOutLeft"
                                                    data-unfold-duration="500">
                                                <span aria-hidden="true"><i class="ec ec-close-remove sasabuy_text_color font-size-20"></i></span>
                                            </button>
                                        </div>
                                        <!-- End Toggle Button -->
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        <div id="headerSidebarHomeCollapse" class="collapse" data-parent="#headerSidebarContent">
                                                            <ul id="headerSidebarHomeMenu" class="u-header-collapse__nav-list">
                                                                ...
                                                                <!-- End Home - v7 -->
                                                                <!-- Home - v8 -->
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="../home/home-v8.html">Home v8</a></li>
                                                                <!-- End Home - v8 -->
                                                                <!-- Home - v9 -->
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="../home/home-v9.html">Home v9</a></li>
                                                                <!-- End Home - v9 -->
                                                                <!-- Home - v10 -->
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="../home/home-v10.html">Home v10</a></li>
                                                                <!-- End Home - v10 -->
                                                                <!-- Home - v11 -->
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="../home/home-v11.html">Home v11</a></li>
                                                                <!-- End Home - v11 -->
                                                                <!-- About -->
                        ...
                        <div class="d-inline-flex">
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col d-xl-none px-2 px-sm-3 position-static">
                                    <a id="searchClassicInvoker" class="font-size-22 sasabuy_text_color text-lh-1 btn-text-secondary" href="javascript:;" role="button"
                                       data-toggle="tooltip"
                                       data-placement="top"
                                       title="Search"
                                ...
                                <li class="col d-none d-xl-block"><a href="../shop/compare.html" class="sasabuy_text_color" data-toggle="tooltip" data-placement="top" title="Compare"><i class="font-size-22 ec ec-compare"></i></a></li>
                                <li class="col d-none d-xl-block"><a href="../shop/wishlist.html" class="sasabuy_text_color" data-toggle="tooltip" data-placement="top" title="Favorites"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                <li class="col d-xl-none px-2 px-sm-3"><a href="../shop/my-account.html" class="sasabuy_text_color" data-toggle="tooltip" data-placement="top" title="My Account"><i class="font-size-22 ec ec-user"></i></a></li>
                                <li class="col pr-xl-0 px-2 px-sm-3">
                                    <a href="../shop/cart.html" class="sasabuy_text_color position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        ...
                                        <span class="d-none d-xl-block font-weight-bold font-size-16 sasabuy_text_color ml-3">$1785.00</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="d-none d-xl-block bg-primary border-color-2">
            <div class="container">
                <div class="min-height-45">
                    <!-- Nav -->
                    <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar u-header__navbar--wide u-header__navbar--no-space" style="background-color: #2441a1;border-right:#FED700 ">
                        <!-- Navigation -->
